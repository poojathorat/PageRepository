...
@property (readonly, strong, nonatomic) PageModelController *modelController;
@end
...
- (void)viewDidLoad
{
    ...
    PageDataViewController *startingViewController = [self.modelController viewControllerAtIndex:0 storyboard:self.storyboard];
